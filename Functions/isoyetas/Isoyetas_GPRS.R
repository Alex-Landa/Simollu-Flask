...
tryCatch(
  expr = {
    ...
    withTimeout({
              ...
              # dev.off()
      png(file = "ThiensenGp.png",res = 305,units = "px",width = 1500,height = 1500) # Crea el Archivo
      print(p1) # Coloca la imagen en el archivo
      dev.off() # Cierra el archivo
      png(file = "idwGp.png",res = 305,units = "px",width = 1500,height = 1500)
      print(p2)
      dev.off()
      png(file = "krigingGp.png",res = 305,units = "px",width = 1500,height = 1500)
      print(p3)
      dev.off()
