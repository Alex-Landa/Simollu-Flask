...
tryCatch(
  expr = {
    ...
    withTimeout({
              ...
              # pdf(file = "isoyetasGP.pdf",   # The directory you want to save the file in
              ...
              # dev.off()
      png(file = "ThiensenHist.png",res = 305,units = "px",width = 1500,height = 1500) # Crea el Archivo
      print(p1) # Coloca la imagen en el archivo
      dev.off() # Cierra el archivo
      png(file = "idwHist.png",res = 305,units = "px",width = 1500,height = 1500)
      print(p2)
      dev.off()
      png(file = "krigingHist.png",res = 305,units = "px",width = 1500,height = 1500)
      print(p3)
      dev.off()
