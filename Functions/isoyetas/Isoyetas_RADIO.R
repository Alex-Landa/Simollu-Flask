...
tryCatch(
  expr = {
    ...
    withTimeout({
      ...
      png(file = "ThiensenRad.png",res = 330,units = "px",width = 1500,height = 1500) # Crea el       Archivo
      print(p1) # Coloca la imagen en el archivo
      dev.off() # Cierra el archivo

      png(file = "idwRad.png", res = 330,units = "px",width = 1500,height = 1500)
      print(p2)
      dev.off()
      
      png(file = "krigingRad.png",res = 330,units = "px",width = 1500,height = 1500)
      print(p3)
      dev.off()
